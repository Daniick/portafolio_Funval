import { logo, github, link, twitter } from "../assets/index";

const Navbar = () => {
  return (
    <header>
      <nav class="border-gray-200 bg-white-50 dark:bg-w0 dark:border-gray-700">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
            <ul class="flex flex-col font-medium mt-4   md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0    ">
              <li>
                <a
                  href="#"
              ...
              <li>
                <a href="#" class="block py-2 px-3 md:p-0 text-gray-800">
                  About
                </a>
              </li>
              <li>
